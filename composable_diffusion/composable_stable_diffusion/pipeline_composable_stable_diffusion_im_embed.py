...
class ComposableStableDiffusionImageEmbedPipeline(DiffusionPipeline):
    r"""
    ...
    def _encode_images(self, image_paths, device, num_images_per_prompt, do_classifier_free_guidance):
        # print('do', do_classifier_free_guidance)
